...
export default class BecLayout extends React.PureComponent {
  ...
  getChildContext() {
    ...
    // const menuData = formatter(menus);
  ...
  render() {
    ...
    // const { currentUser, collapsed, fetchingNotices, notices, routerData, match, location, menus } = this.props;
      ...
      <Layout>
        ...
        <Layout>
          <Header style={{ padding: 0 }}>
            {/* <div> */}
            {/* <Websocket url="ws://localhost:1339/notice" onMessage={this.handleWebSocketData.bind(this)} /> */}
            {/* </div> */}
            <GlobalHeader
              logo={logo}
              ...
              newNoticeCount={this.state.noticeCount}
            />
          </Header>
